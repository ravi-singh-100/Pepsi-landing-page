...
pepsi.src="./pepsi landing page/pepsi images/black_pepsi.png"

}
const blue = () => {
home.style.backgroundColor="#0043ffe0";
pepsi.style.animation="pepsi_move_2 1s ease-out 1";
pepsi.src="./pepsi landing page/pepsi images/blue_pepsi.png";
...
// pepsi.style.animation="pepsi_move_2 1s ease-out 1";
pepsi.src="./pepsi landing page/pepsi images/silver_pepsi.png";
